...
export const SymbolMarker: FC<SymbolMarkerProps> = memo(({ ident, x, y, endX, endY, arcRadius, arcSweep, type, constraints, length, direction, radials, radii, mapParams, ndRange }) => {
    ...
    } else if (type & (NdSymbolTypeFlags.PwpLevelOffForConstraintClimb)) {
        showIdent = false;
        elements.push(
            <>
                <path d="M -38, 17 l 17, -17 h 21 m -5, -5 l 5, 5 l -5, 5" strokeWidth={1.8} className="shadow" />
    ...
    } else if (type & (NdSymbolTypeFlags.PwpLevelOffForConstraintDescent)) {
        showIdent = false;
        elements.push(
            <>
                <path d="M -38, -17 l 17, 17 h 21 m -5, -5 l 5, 5 l -5, 5" strokeWidth={1.8} className="shadow" />
    ...
    } else if (type & (NdSymbolTypeFlags.PwpBottomOfDescent)) {
        showIdent = false;
        elements.push(
            <>
                <path d="M -38, -17 l 17, 17 h 21 m -5, -5 l 5, 5 l -5, 5" strokeWidth={1.8} className="shadow" />
    ...
    } else if (type & (NdSymbolTypeFlags.PwpContinueDescent)) {
        showIdent = false;
        elements.push(
            <>
                <path d="M 0, 0 h 21 l 17 17 m -5, 0 l 5, 0 l 0, -5" strokeWidth={1.8} className="shadow" />
